...
RUN apk --update add nodejs npm php8 php8-curl php8-dom php8-fileinfo php8-gd php8-exif php8-openssl php8-pcntl php8-phar php8-session php8-simplexml php8-sockets php8-tokenizer php8-xml php8-xmlwriter git
